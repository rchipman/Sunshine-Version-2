...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    protected void onPostExecute(String[] forecastArray) {
        ...
        ForecastFragment.mForecastAdapter.addAll(forecastArray);
    }
    ...
    protected String[] doInBackground(String... strings) {
        ...
        try {
            ...
            Uri api = Uri.parse("http://api.openweathermap.org/data/2.5/forecast/daily?")
                    .buildUpon()
        ...
        if (forecastJsonStr != null) {
            try {
                weather = getWeatherDataFromJson(forecastJsonStr, numDays);
